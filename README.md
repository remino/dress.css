...
This stylesheet was formerly known as **sem.css** in version 1.2.4, and renamed
as **dress.css** in version 2.0.0.
...
There are many ways to include this stylesheet in your code. Here are a few
examples:
...
To know which HTML tags are handled by this stylesheet with some suggested
markup, see _[Elements](https://remino.net/dress.css/elements/)_.
...
The **<mark>dress.css</mark>** stylesheet was checked with
...
While **<mark>dress.css</mark>** should work in the latest version of major
browsers, it seems to have issues in some less-popular mobile versions, like
...
_[License](https://remino.net/dress.css/license/)_.
